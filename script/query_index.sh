...
QUERY_PATHS=("${root_path}data/yt8m_video_querys_10k.fvecs"
...
GROUNDTRUTH_PATHS=("${root_path}groundtruth/yt8m_video_benchmark-groundtruth-deep-1m-num1000-k10.arbitrary.cvs"
    "${root_path}groundtruth/wiki_image_benchmark-groundtruth-deep-1m-num1000-k10.arbitrary.cvs"
    #    "${root_path}groundtruth/deep_benchmark-groundtruth-deep-1m-num1000-k10.arbitrary.cvs"
